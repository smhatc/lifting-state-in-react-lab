...
import './components/IngredientList.jsx'
import './components/BurgerStack.jsx'
import './App.css';
...
const App = () => {
  ...
  const removeFromBurger = (ingredientToRemoveIndex) => {
    setStack(stack.filter((ingredient, index) => index !== ingredientToRemoveIndex));
  }
